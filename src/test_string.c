...
START_TEST(s21_sprintf_test_c) {
  ...
  char str2[1000] = {0};
  wchar_t c1 = 'T', c2 = 'Z';
  int r1 = sprintf(str1, "%10c%-10c%25c%-30c%25c%8c%2c%8c%lc%-50lc", 'a', 'f',
                   'R', 'Q', 10, 'P', 'L', 20, c1, c2);
...
START_TEST(s21_sprintf_test_s) {
  ...
  int r2 = s21_sprintf(str2, "%s%23s%-15s%10.s%15.2s%16.8s%7.5s%8s%15ls%15.3ls",
                       "aboba", "helloworld", "ABOBA", "ABOBBAAA", "AAABOBA",
                       "QWERTY", "AAAAABOOOOOBAAA", "ABOBAAAAA", s, s);
  ck_assert_pstr_eq(str1, str2);
  ck_assert_int_eq(r1, r2);
...
START_TEST(s21_sprintf_test_d_s) {
  ...
  short h = 34;
  int r1 = sprintf(str1,
                   "%-25.10d%-30.2d%10.12d%11d%8d%8.8d%+-25.8ld%+10.2d%-11.8hd",
...
START_TEST(s21_sprintf_test_i_s) {
  ...
  int r2 =
      s21_sprintf(str2, "%+50.i%-10.20i%10.i%12i%8.8i%-10.8i%+10.1li%8.25hi",
                  34567, 225, 5230, 125, 10, 66, l, h);
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(r1, r2);
}
...
START_TEST(s21_sprintf_test_c_s) {
  ...
  char str2[1000] = {0};
  wchar_t c1 = 'T', c2 = 'Z';
  int r1 = sprintf(str1, "%10c%-10c%25c%-30c%25c%8c%2c%8c%lc%-50lc", 'e', 'f',
                   'R', 'Q', 10, 'P', 'L', 20, c1, c2);
  int r2 = s21_sprintf(str2, "%10c%-10c%25c%-30c%25c%8c%2c%8c%lc%-50lc", 'e',
                       'f', 'R', 'Q', 10, 'P', 'L', 20, c1, c2);
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(r1, r2);
}
...
START_TEST(s21_sprintf_test_s_s) {
  ...
  char str2[1000] = {0};
  wchar_t s[10] = {'h', 'e', 'l', 'l', 'o'};
  int r1 = sprintf(str1, "%s%23s%-15s%10.s%15.2s%16.8s%8.8s%8s%15ls%15.3ls",
                   "aboba", "helloworld", "ABOBA", "ABOBBAAA", "AAABOBA",
                   "QWERTY", "AAAAABOOOOOBAAA", "ABOBAAAAA", s, s);
  int r2 = s21_sprintf(str2, "%s%23s%-15s%10.s%15.2s%16.8s%8.8s%8s%15ls%15.3ls",
                       "aboba", "helloworld", "ABOBA", "ABOBBAAA", "AAABOBA",
                       "QWERTY", "AAAAABOOOOOBAAA", "ABOBAAAAA", s, s);
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(r1, r2);
...
START_TEST(s21_sprintf_July_test_2) {
  ...
  ck_assert_int_eq(s21_sprintf(c, "%-4.3d", d), sprintf(c, "%-4.3d", d));
  ck_assert_int_eq(s21_sprintf(c, "%+4.3d", d), sprintf(c, "%+4.3d", d));
  ck_assert_int_eq(s21_sprintf(c, "% 4.3d", d),
                   sprintf(c, "% 4.3d", d));  //  flag space
  ck_assert_int_eq(s21_sprintf(c, "%-+4.3d", d), sprintf(c, "%-+4.3d", d));
  ck_assert_int_eq(s21_sprintf(c, "%+-4.3d", d), sprintf(c, "%+-4.3d", d));
  //  2.  w>(pr=count)
  ck_assert_int_eq(s21_sprintf(c, "%d", d), sprintf(c, "%d", d));
  ...
  ck_assert_int_eq(s21_sprintf(c, "%-4.2d", d), sprintf(c, "%-4.2d", d));
  ck_assert_int_eq(s21_sprintf(c, "%+4.2d", d), sprintf(c, "%+4.2d", d));
  ck_assert_int_eq(s21_sprintf(c, "% 4.2d", d),
                   sprintf(c, "% 4.2d", d));  //  flag space
  ck_assert_int_eq(s21_sprintf(c, "%-+4.2d", d), sprintf(c, "%-+4.2d", d));
  ck_assert_int_eq(s21_sprintf(c, "%+-4.2d", d), sprintf(c, "%+-4.2d", d));
  //  3.  (w=pr)>count
  ck_assert_int_eq(s21_sprintf(c, "%d", d), sprintf(c, "%d", d));
  ...
  ck_assert_int_eq(s21_sprintf(c, "%-4.4d", d), sprintf(c, "%-4.4d", d));
  ck_assert_int_eq(s21_sprintf(c, "%+4.4d", d), sprintf(c, "%+4.4d", d));
  ck_assert_int_eq(s21_sprintf(c, "% 4.4d", d),
                   sprintf(c, "% 4.4d", d));  //  flag space
  ck_assert_int_eq(s21_sprintf(c, "%-+4.4d", d), sprintf(c, "%-+4.4d", d));
  ck_assert_int_eq(s21_sprintf(c, "%+-4.4d", d), sprintf(c, "%+-4.4d", d));
